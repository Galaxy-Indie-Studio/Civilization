...
public class CharacterCommands implements CommandExecutor {
    ...
    private String treasonBounty = plugin.getConfig().getString("Treason-Bounty");
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("set")) {
            ...
            if (args[1].equalsIgnoreCase("gender")) {
                ...
                TextComponent male = new TextComponent(ChatColor.BLUE + "Male");
                male.setBold(true);
                ...
                TextComponent female = new TextComponent(ChatColor.LIGHT_PURPLE + "Female");
                female.setBold(true);
            ...
            if (args[1].equalsIgnoreCase("allegiance")) {
                ...
                air.setBold(true);
                air.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/char set allegiance air"));
                ...
                water.setBold(true);
                water.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/char set allegiance water"));
                ...
                earth.setBold(true);
                earth.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/char set allegiance earth"));
                ...
                fire.setBold(true);
                fire.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/char set allegiance fire"));
